...
example : State.allZeros.NF = false := by rfl
example : State.allZeros.ZF = false := by rfl
example : State.allZeros.CF = false := by rfl
example : State.allZeros.VF = false := by rfl

example : State.allZeros.XZR = 0#64 := by rfl
...
example : State.allOnes.NF = true := by rfl
example : State.allOnes.ZF = true := by rfl
example : State.allOnes.CF = true := by rfl
example : State.allOnes.VF = true := by rfl

example : State.allOnes.XZR = 0#64 := by rfl
